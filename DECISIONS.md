...
| 18 | **B8** — is there a boss? | **A, one big boss: the COW KILLER BEE**, "a queen bee with a very long stinger". 2400hp, 30 dps, **reach 130**, only in the last wave of cave 10 | The long stinger is taken literally, so she out-reaches every melee bat: Scouts and Brutes die without touching her. The Archer is the answer (240). *(From 2026-09-20 the Necrobatcer's 200 also clears her stinger, but at 3.3 dps it is no threat to her — see D46.)* `DESIGN.md` §4 | 2026-09-19 |
...
| D46 | The Necrobatcer **casts from the back**: attack reach 60 → **200** | `data/units.js`. Damage untouched at 3.3 dps | Jeff's call, and it fixed a real incoherence: the bat's **summon** reach was 460 but its **attack** reach was 60, and a unit walks forward until something is inside its *attack* range — so the summoner marched into the scrum it was meant to stand behind. Measured in a real battle: it now averages **174px** from the nearest bug across 138 samples and is **never** inside the old 60px reach. **200 rather than the Archer's 240** because being the longest reach in Palopa is the Archer's identity (B9) and the boss fight turns on it | 2026-09-20 |
| D47 | The sim never bought a Necrobatcer, so it had **never been measured** | New SUMMONER BUILD section in `tools/balance-sim.js`: a Scout-spammer who also sends Necrobatcers | Found while making D46. Neither modelled player ever fielded the bat — the cheapest-first player always takes the 25-energy Scout, the priciest-first always takes the 90-energy Brute, and the 60-energy summoner **fell down the crack between them**. Every cave that offers it reported `0.00 bats raised`. So its balance had only ever been checked in the Graveyard, where it happens to be the dearest thing on the menu. This is the D10/D22 mistake for the third time: the tool silently did not model the thing being changed | 2026-09-20 |
